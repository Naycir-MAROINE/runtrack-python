def check_developer_type(langage):
...
check_developer_type("JavaScript")
check_developer_type("python")
check_developer_type("java")
check_developer_type("reactjs")
check_developer_type("C++")